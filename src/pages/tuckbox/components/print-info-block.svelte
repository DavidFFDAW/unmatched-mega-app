...
<div class="w1 box p">
    ...
    <ul class="flex column gap-5">
        ...
        <li>La impresión se realiza sobre una cartulina de entre <strong>200g</strong> y <strong>250g</strong> con brillo <span class="carefull">(se trata de que sea consistente pero que tampoco sea muy grueso para que no quite espacio)</span>.</li>
