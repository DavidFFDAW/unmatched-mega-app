<script lang="ts">
	...
	const returnCardToHand = (card: any) => {
		functions.returnCardToHand(card);
		functions.selectCard(null);
	};

	const putCardInTopHand = (card: any) => {
		functions.putCardInTopHand(card);
		functions.selectCard(null);
	};
</script>
...
<div class="flex center acenter down">
	<div class="flip-card" class:flipped>
		<div class="flip-card-inner">
			<div class="flip-card-front">
				<UnmatchedRealCard {card} width={cardSizes.width} height={cardSizes.height} />
			</div>
			<div class="flip-card-back">
				<CardBack
					width={cardSizes.width}
					height={cardSizes.height}
					src={deck.deckData?.deck_data.appearance.cardbackUrl}
				/>
			</div>
		</div>
	</div>
...
<section class="single-card-buttons column gap">
	<div class="btn-wrapper flex center acenter column gap-smaller">
		<button
			aria-label="Flip card"
			class="card-button button-flip-card"
			on:click={() => {
				flipped = !flipped;
			}}
			><svg
		...
		<p class="btn-description-text">Girar</p>
	</div>

	{#if card.deckPlace !== 'discard'}
		<div class="btn-wrapper flex center acenter column gap-smaller">
			<button class="card-button button-discard-card" on:click={() => discard(card)}>
				<svg
					version="1.1"
					width={svgSizes}
					height={svgSizes}
	...
	{#if card.deckPlace === 'discard'}
		<div class="btn-wrapper flex center acenter column gap-smaller">
			...
			<p class="btn-description-text">A la mano</p>
		</div>
	{/if}
...
<style>
	...
	.single-card-buttons .button-return-card {
		fill: #fff;
