<script lang="ts">
	export let lettersColor: string = '#000';
	export let backgroundColor: string = '#eee';
</script>
...
<svg
	...
	/>
	<g
		transform="matrix(0.09657963,0,0,-0.09324664,-4.677553,243.11689)"
		fill="#000000"
		stroke="none"
		id="g26"
	...
	>
		<path
			style="display: inline; fill: {backgroundColor}; stroke-width: 0; paint-order: stroke fill markers"
		...
		<path
			...
			id="path2"
			style="display: inline; fill: {lettersColor}"
		/>
		<path
