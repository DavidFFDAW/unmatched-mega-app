			...
			<div class="flex col">
				...
				<div class="inputs-group">
					...
					<div>
						...
						<input type="radio" name="number" value="1" on:change={() => setData('qty', '1')} />1
						<input type="radio" name="number" value="2" on:change={() => setData('qty', '2')} />2
						<input type="radio" name="number" value="3" on:change={() => setData('qty', '3')} />3
						<input type="radio" name="number" value="4" on:change={() => setData('qty', '4')} />4
						<input type="radio" name="number" value="5" on:change={() => setData('qty', '5')} />5
					</div>
					...
					<div class="form-item">
						...
						<input
							...
							class="custom uppercase"
							type="number"
							on:input={setCharacterNameHeight}
							placeholder="80"
							min="65"
						/>
					</div>
				...
				<div class="input-groups">
					<div class="form-item column">
						...
						<textarea
							...
							class="custom"
							on:input={(e) => setData('inmediate', e?.target?.value)}
						/>
						<input
							type="color"
					...
					<div class="form-item column">
						...
						<textarea
							...
							class="custom"
							on:input={(e) => setData('during', e?.target?.value)}
						/>
						<input
							type="color"
					...
					<div class="form-item column">
						...
						<textarea
							...
							class="custom"
							on:input={(e) => setData('after', e?.target?.value)}
						/>
						<input
							type="color"
					...
					<div class="form-item column">
						...
						<textarea
							id="rayitoTextarea"
							class="custom"
							on:input={(e) => setData('rayito', e?.target?.value)}
						/>
